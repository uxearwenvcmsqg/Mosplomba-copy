...
const Slider: React.FC = () => {
    ...
    const fetchSlides = async () => {
        try {
            const response = await axios.get<SlideData[]>("https://67448498b4e2e04abea28987.mockapi.io/Plomba");
            ...
            const slideElements = data.map((slide, index) => (
                <div className="">
                    <div className="item" key={index}>
                        ...
                        <div className="">
                            <img className="mt-[90px]  max-w-[948px] min-w-[500px] ml-[-107px]" src={slide.image}/>
                        </div>
                    </div>
                </div>
            ))
    ...
    if (isLoading) {
        return (
            <div>Loading, wait, they don't love you like i love you</div>
        )
    }
    return (
        <Carousel>
